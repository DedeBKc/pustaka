                ...
                <div class="col-md-3">
                  <div class="list-group">
                      <a href="" class="list-group-item active"><i class="fa fa-cogs"></i> MENU BUKU</a>
			                <a href="{{ url('/staff/buku') }}" class="list-group-item"><i class="fa fa-refresh"></i> Tampilkan Semua</a>
			                <a href="{{ url('/home') }}" class="list-group-item"><i class="fa fa-home"></i> Home</a>
                  </div>
                </div>
